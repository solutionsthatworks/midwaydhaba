...
<head>
	...
	<title>MHO - Hotel and Bed &amp; Breakfast</title>
...
-->
					...
					<div class="main-menu">
						...
						<ul>
							...
							<li><a href="<?= base_url('Hotel-Lists');?>">Hotels</a>
							</li>
							<li><a href="<?= base_url('Our-Brands');?>">Our Brands</a>
							</li>
							...
							echo "<li><a href='#'>Hello ".$uname."</a></li>";
								...
								<li><a href="<?= base_url('Users-Profile/').$uid; ?>">Account</a></li>
								<li><a href="<?= base_url('logout') ?>">Logout</a>
								<?php
							}else{
								?>
								<li><a href="<?= base_url('Users-Login'); ?>" >MHO Account</a> <!-- /Sign In -->
								</li>
<!--
								<li><a href="<?= base_url('Users-Register'); ?>" >Register</a> /Sign Up
								</li>
-->
								<?php
							}
