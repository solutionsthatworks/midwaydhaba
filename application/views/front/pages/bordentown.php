    ...
    <div class="col-md-8" id="room_detail_desc">
      <div id="single_room_feat">
        <ul>
          ...
          <li><i class=" icon_set_1_icon-59"></i>Free Coffee</li>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <p align="justify"> Located off Interstate NJ TURNPIKE , HWY. 95 and State HWY 295. With access to fine dining, Restaurant, Diner, Fast food and gas within walking distance.</p>
      ...
      <div class="row">
        ...
        <h4 >Beautifully furnished three types of rooms</h4>
        <div class="col-md-9">
              ...
              <div class="col-md-12 col-sm-12">
                <div class="form-group">
                  <?php 
					if(isset($uid)){
					?>
							<input type="button" onClick="location.href='https://reservation.asiwebres.com/v4/RoomAvailability.aspx?id=bbbf6f53c7b24bbfa1a67b4d8002427e&lang=en&Curr=1&txtPromocode=MHOMEMBER&tag=Member';" value="Book now" class="btn_full book_now">
					<?php
						}else{
					?>
...
<!--                  https://reservation.asiwebres.com/v2/RoomAvailability.aspx?id=e4a7f014288c4350a1a56589ea5b46d0&txtPromocode=EVERYDAY10-->
          ...
          <div align="center">
          187, RT. 130, Bordentown, NJ 08505. USA <a href="tel://6092985000" id="phone_2"><i class="icon_set_1_icon-91"></i>+1 (609) 298-5000</a>   
			</div>
