...
<div class="carousel_in">
    ...
    <h1 class="main_title_in">MHO Suites – La Mirage </h1>
    <div class="container add_bottom_60">
        ...
        <div class="row">
         ...
         <div class="row">
                ...
                <div class="col-md-9">
                    <p>
                        MHO Suites – La Mirage  - Hotel in Monmouth Junction NJ, is the right choice for visitors who are searching for a combination of charm and a convenient position from where to explore surroundings. The Motel office is open 24 hours a day. Our friendly staff can point you in the direction of local events and activities and arrange a wake-up call. All rooms are equipped with basic cable and HBO and most of our rooms offer two queen-size beds.
...
-->
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                	<div id="score_detail"><span>3.9</span>Good <small>(Based on 98 reviews)</small></div><!-- End general_rating -->
...
-->
                    ...
                    <div class="review_strip_single">
                        ...
                        <small>Check-in Jul 9, 2020</small>
                        <h4>Verified CheapTickets guest review</h4>
                        <p>
                             "It was a great stay just need to put more them one tooth brush in the room with two or more people"
                        </p>
                        <div class="rating">
...
<!--                        <a href="#0" class="btn_outline"> -->
                        3775 U.S. HWY #1, Monmouth Junction,  NJ, USA - 08852
<!--                        </a>-->
