...
<!--                  <option value="Plaza Motel Mays, Mays Landing, NJ">Plaza Motel Mays, Mays Landing, NJ</option>-->
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <input id="txtCheckOutDate" type="date" class="form-control calender" name="txtCheckOutDate" value="" required maxlength="10" aria-describedby="dateformat"  />
<!--
                  <input class="date-pick form-control" type="text" id="check_inn" name="check_in" data-date-format="M d, D" placeholder="Check in Date" readonly>
...
-->
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input id="txtCheckOutDate" type="date" class="form-control calender" name="txtCheckOutDate" value="" required maxlength="10" aria-describedby="dateformat"  />
<!--
                    <input class="date-pick form-control" type="text" id="check_outt" name="check_out" data-date-format="M d, D" placeholder="Check out Date" readonly>
                    <span class="input-icon"><i class="icon-calendar-7"></i></span>
-->
                  </div>
                </div>
...
<script> 
        function countWord() { 
            ...
            var words = document 
                .getElementById("qus_twentey").value; 
            ...
            document.getElementById("show") 
              ...
              <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <textarea name="qus_twentey" id="qus_twentey" cols="70" rows="3" maxlength="500" oninput="countWord()" required></textarea>
                    <p> Word Count: 
