...
<div class="carousel_in">
  <div><img src="images/Plaza Motel Mays/plaza-motel.png" alt="">
    <div class="caption">
      <h3>Stay Safe</h3>
    </div>
  </div>
  <div><img src="images/Plaza Motel Mays/plaza.1.jpg" alt="">
    <div class="caption">
      <h3>Free parking</h3>
    </div>
  </div>
  <div><img src="images/Plaza Motel Mays/plaza.outdoor.jpeg" alt="">
    <div class="caption">
      <h3>Nice View</h3>
    </div>
  </div>
  <div><img src="images/Plaza Motel Mays/plaza.outdoor.view.jpeg" alt="">
    <div class="caption">
      <h3>Relaxed evenings</h3>
    </div>
  </div>
  <div><img src="images/Plaza Motel Mays/2020-04-16.jpg" alt="">
    <div class="caption">
      <h3>easy access</h3>
    </div>
  </div>
</div>
<h1 class="main_title_in">Plaza Motel Mays Landing POWERED
  BY MHO HOTELS</h1>
...
--> 
          ...
          <hr>
          <div class="review_strip_single"> <img src="img/avatar1.jpg" alt="" class="img-circle"> <small>9 month ago</small>
            <h4>Milan Sapkota - on Google</h4>
            <p> "I stayed here before, but it was rough but now with the new management in place They have brought this place to next level, all rooms are renovated. Most importantly they work with you. I recommend to stay here than any other motel in area" </p>
          ...
          <div class="review_strip_single"> <img src="img/avatar2.jpg" alt="" class="img-circle"> <small>8 month ago</small>
            <h4>Tonny Faison - on Google</h4>
            <p> "The owners are very nice and rooms are new and clean. I would definetly come back here. Especially the owners understand you and are not like other places i have been." </p>
            <div class="rating"> <i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star-empty"></i> </div>
          </div>
          <!-- End review strip -->
          
          <div class="review_strip_single last"> <img src="img/avatar3.jpg" alt="" class="img-circle"> <small>8 months ago</small>
            <h4>Random Dude - on Google</h4>
            <p> "Nice property, close to Atlantic City and far from all the noise. Nice hot water and heat. Definitely a place to stay" </p>
      ...
      <div class="theiaStickySidebar">
        <div class="box_style_1">
          ...
          <form method="post" action="#" autocomplete="off" >
            <input name="room_type" id="room_type" type="hidden" value="plazamotel">
            
            <div class="row"> 
              <div class="col-md-12 col-sm-12">
                <div class="form-group">
                  <input type="submit" value="Book now" class="btn_full book_now" >
                </div>
              </div>
            </div>
          </form>
...
<!--          <a href="#0" class="btn_outline"> -->
          6090 E Black Horse Pike, Mays Landing, NJ 08330, USA
<!--          </a> -->
          <a href="tel://6096254307" id="phone_2"><i class="icon_set_1_icon-91"></i>+1 609-625-4307</a> </div>
        <!-- End box_style --> 
      </div>
