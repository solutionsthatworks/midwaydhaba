  ...
  public function update_user_profile(){
    ...
    public function forgot_password(){
       if(isset($_POST['send'])){
        ...
        $checkemail = $this->Admin_model->get_row(REGISTERUSER,array('user_email'=>$email,'is_active'=>1));
       /* echo "<pre/>";
...
You can reset your password by click this link:</p><p>'.$link.' </p><p>If you did not request a password reset, no further action is required. </p><p>Thanks and Best Regards!</p>';
                    ...
                    $this->email->from('info@aasthacollegeofeducation.com');
    ...
    public function change_password(){
        ...
        if(isset($_POST['reset_password'])){
            ...
            $where = array('id'=>$id);
            $update_pass = array('password'=>$newpass);
