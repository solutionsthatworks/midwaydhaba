...
public function country_house(){
        $this->render_second('front/pages/country_house','');
    }
...
public function tunkhannock(){
        $this->render_second('front/pages/tunkhannock','');
    }
...
//    }
    ...
    public function menu_list(){
        echo "Tuhi";die;
            // $this->render('front/pages/menu_list','');
            // $this->render_second('front/pages/menu_list','');
    }
}
