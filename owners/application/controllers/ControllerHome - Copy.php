...
//For place order email
	...
	{
            $this->form_validation->set_rules('user_name','User Name','required|alpha|trim');
...
//             if($result==TRUE){open this for email sending
...
//Send Email
        ...
        $result==TRUE?redirect(base_url().'/Users-Register','refresh'):FALSE;
