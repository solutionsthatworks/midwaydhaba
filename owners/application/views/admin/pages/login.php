  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?= base_url('asset/admin/'); ?>index2.html"><b>MHO</b>HOTEL</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg"> Please sign in</p>
        <form action="<?= base_url('/Admin/ControllerAdmin/index'); ?>" method="post">
...
<!--         <div class="social-auth-links text-center">
    ...
    <!-- iCheck -->
    <script src="<?= base_url('asset/admin/'); ?>plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
