...
<!--    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">-->
    <link rel="stylesheet" href="<?= base_url('asset/admin/'); ?>dist/css/font-awesome.min.css">
    <!-- Ionicons -->
<!--    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">-->
   <link rel="stylesheet" href="<?= base_url('asset/admin/'); ?>dist/css/ionicons.min.css">
    <!-- Theme style -->
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?= base_url('asset/admin/'); ?>plugins/select2/select2.min.css">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                     <?php
						...
						?>
                      <a href="<?= base_url('Update-Profile/').$userid ?>" class="btn btn-default btn-flat">Change Password</a>
                    </div>
