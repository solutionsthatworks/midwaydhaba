...
<h1 class="main_title_in">MHO HOTEL - BORDENTOWN</h1>
  ...
  <div class="row">
    <div class="col-md-8" id="room_detail_desc">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <p> Welcome to MHO Hotel-Bordentown, the right hotel in Bordentown NJ when you need an affordable stop that’s a pleasant place to stay on business or pleasure. We’re near several institutions of higher learning, including Princeton University, Rider University, The College of New Jersey – and so much more.
            When you make us your hotel in Bordentown, New Jersey, additional attractions nearby include Roebling Museum, Waterfront Park, CURE Insurance Arena, Trenton War Memorial Theater, Old Barracks Museum, Six Flags Great Adventure, New Egypt Speedway Fort Dix and many more things too numerous to mention. We may be a bargain hotel, but we feature excellent amenities, including a free wifi, free coffee and juices at all hours plus in-room features like refrigerators, microwaves and hair dryers. It all adds up to exceptional value. </p>
          <p> When you want an easy-to-locate pick of hotels near Six Flags Great Adventure NJ, we’re just 22 miles away. We’re also the right Bordentown hotel near Rider University. Plus, we’re just 6 miles from downtown Trenton and near so many points of interest that you’ll want to experience while in the area. When you stay with us, you’re not just selecting the most affordable of the hotels Bordentown NJ has available. You’re also opting for a convenient and easy-to-access property. Make us your first selection and you’re sure to be satisfied. With free wifi, a free continental breakfast and other perks, you’re certain to like staying with us. </p>
...
--> 
          ...
          <div class="review_strip_single"> <img src="<?= base_url('asset/') ?>images/avatar3.jpg" alt="" class="img-circle"> <small> a month ago on Google</small>
            <h4>Trypp Adams</h4>
            <p> "I booked this on bookin dt com for $52 a night with taxes. Check in is a little goofy as you stand outside and communicate through a small window. The room was nice, clean and quiet. They seem to be also known as the Skybridge Inn and Suites. All in all, great value and good nights sleep." </p>
          ...
          <div class="review_strip_single"> <img src="<?= base_url('asset/') ?>images/avatar3.jpg" alt="" class="img-circle"> <small> 5 Month ago on Expedia</small>
            ...
            <p> "I am truly happy with Skybridge. Overall, the property itself truly needs updating and modernization. However, aside from this, I enjoyed my stay. …" </p>
            <div class="rating"> <i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star-empty"></i> </div>
          </div>
          <!-- End review strip -->
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <ul id="policies">
            ...
            <li><i class="icon_set_1_icon-54"></i>
              <h5>Cancellation</h5>
    ...
    <div class="col-md-4" id="sidebar">
      <div class="theiaStickySidebar">
        <div class="box_style_1">
          ...
          <form method="post" action="https://reservation.asiwebres.com/v4/RoomAvailability.aspx?id=bbbf6f53c7b24bbfa1a67b4d8002427e&lang=en&Curr=1" autocomplete="off" >
...
-->
          ...
          187 US 130 &nbsp; 206, Bordentown, New Jersey 08505, USA <a href="tel://6092985000" id="phone_2"><i class="icon_set_1_icon-91"></i>+1 (609) 298-5000</a> </div>
        <!-- End box_style --> 
      </div>
