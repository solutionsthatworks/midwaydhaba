			...
			<div class="row">
				...
				<div class="col-md-5 col-sm-8">
					<div class="form-group">
						...
						<input type="tel" id="user_phone" name="user_phone" class="form-control" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="Enter Phone number" minlength="10" maxlength="14"><small>Format: 234-567-8901</small>
