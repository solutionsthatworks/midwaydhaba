...
<div class="carousel_in">
      <div><img src="images/Prince Hotel/prince_hotel.jpeg" alt=""><div class="caption"><h3>Fantastic View</h3></div></div>
      <div><img src="images/Prince Hotel/Prince_Hotel.PNG" alt=""><div class="caption"><h3>Big lobby</h3></div></div>
      <div><img src="images/Prince Hotel/Prince_Hotel_bed.PNG" alt=""><div class="caption"><h3>King size rooms</h3></div></div>  
         <div><img src="images/Prince Hotel/Prince_Hotel_bar.PNG" alt=""><div class="caption"><h3>Relaxed evenings</h3></div></div>
          
      <div><img src="images/Prince Hotel/Prince_Hotel_doublebed.PNG" alt=""><div class="caption"><h3>Stay Safe</h3></div></div>

      
    </div>
    
    
    <h1 class="main_title_in">Prince Hotel by MHO HOTELS</h1>
    <div class="container add_bottom_60">
        ...
        <div class="row">
         ...
         <div class="row">
                ...
                <div class="col-md-9">
                    <p>
                        Located in the heart of downtown Tunkhannock, PA, The Prince Hotel, an Ascend Hotel Collection Member offers guests a slice of historical significance in the area. The large Greek revival-themed three-story building was erected in 1844 and has been used as a hotel continuously since its construction.
                        </p>
                        <p>
Additional amenities include free wireless high-speed Internet access and free parking on premises. All guest rooms offer a 32-inch television, hair dryer, iron and ironing board. Some rooms feature a sofa sleeper, living room and whirlpool.
After checking out the area, relax and unwind in the Prince Dining Room, conveniently located on-site and serving delicious Italian fare. Grab a drink in the Prince Lounge and take advantage of the meeting room, which can accommodate 60 people for banquets.
It is keeping guests close to the attractions they seek in the area, including Lake Curey, Shadowbrook Golf Course, Lake Winola, Lackawanna State Park and Endless Mountains Nature Center.
...
-->
            ...
            <div class="theiaStickySidebar">
            	<div class="box_style_1">
                    ...
                    <input name="room_type" id="room_type" type="hidden" value="prince">	
<!--
                    	<div class="row">
                        	<div class="col-md-6 col-sm-6">
...
<!--                        <a href="#0" class="btn_outline"> -->
                        45 E Tioga St, Tunkhannock, PA 18657, United States
<!--                        </a>-->
                        <a href="tel://5708362292" id="phone_2"><i class="icon_set_1_icon-91"></i>+1 570-836-2292</a>
